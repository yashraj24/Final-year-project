...
''')
        os.system('gdown --id 1a96csMvUsc0U8PoqLZ4kAr_OBMVo2tfX')
...
def hadoop_pyscript(ip, hdfs_name_tag, hdfs_value_tag, node_type, dn_no, curr_ip):
    ...
    pyscript = ['import os\n', 
    'os.system("pip3 install gdown")\n', 
    'os.system("gdown --id 1WiSiWkvW1iCSZSH0jnyk9yD7WetLB46h")\n', 
    'os.system("gdown --id 1FwzKwFWdviB8DkRvWBKIVelrdp7Rq-6p")\n', 
